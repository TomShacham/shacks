import {nodeHttpClient, Req, Res, Route, Router} from "../../../packages/h22p/src";
import {expect} from "chai";
import {describe, it} from "mocha"
import * as crypto from 'crypto';
import {Body, h22pServer, HttpHandler, HttpRequest, HttpResponse} from "@shacks/h22p";
...
describe('open telemetry', () => {
    it('tracing http requests', async () => {
