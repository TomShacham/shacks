...
export class Req {
    ...
    static get<
        ...
        Uri extends string,
        ReqHds extends HttpRequestHeaders,
    >(path: Uri, headers: HttpRequestHeaders = {}): HttpRequest<'GET', Uri, undefined, ReqHds> {
        return {method: 'GET', body: undefined, uri: path, headers: headers as ReqHds}
    }
    ...
    static post<
        ...
        Uri extends string,
        ReqHds extends HttpRequestHeaders,
    >(path: Uri, body: B, headers: ReqHds = {} as ReqHds): HttpRequest<"POST", Uri, B, ReqHds> {
    ...
    static put<
        ...
        Uri extends string,
        ReqHds extends HttpRequestHeaders,
    >(path: Uri, body: B, headers: ReqHds = {} as ReqHds): HttpRequest<"PUT", Uri, B, ReqHds> {
    ...
    static patch<
        ...
        Uri extends string,
        ReqHds extends HttpRequestHeaders,
    >(path: Uri, body: B, headers: ReqHds = {} as ReqHds): HttpRequest<"PATCH", Uri, B, ReqHds> {
    ...
    static delete<
        ...
        Uri extends string,
        ReqHds extends HttpRequestHeaders,
    >(path: Uri, body: B, headers: ReqHds = {} as ReqHds): HttpRequest<"DELETE", Uri, B, ReqHds> {
        /*
    ...
    static options<
        ...
        Uri extends string,
        ReqHds extends HttpRequestHeaders,
    >(path: Uri, headers: HttpRequestHeaders = {}): HttpRequest<'OPTIONS', Uri, undefined, ReqHds> {
    ...
    static trace<
        ...
        Uri extends string,
        ReqHds extends HttpRequestHeaders,
    >(path: Uri, headers: HttpRequestHeaders = {}): HttpRequest<'TRACE', Uri, undefined, ReqHds> {
        return {method: 'TRACE', uri: path as Uri, body: undefined, headers: headers as ReqHds}
    }
    ...
    static head<
        ...
        Uri extends string,
        ReqHds extends HttpRequestHeaders,
    >(path: Uri, headers: HttpRequestHeaders = {}): HttpRequest<'HEAD', Uri, undefined, ReqHds> {
